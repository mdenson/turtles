				...
				Beach.list.map(function(b) {
					return m(".w3-col m4 w3-padding-16", [
						m(".w3-container w3-card-4 w3-dark-grey", [
							m(".w3-container w3-center", [
//								m("h1", "Pic"),
								m("h1", b.doc.name),
								m("h5", b.doc.state + ", " + b.doc.country)
							],
							m("a.w3-button w3-green", { href: "/beaches/" + b.doc._id, oncreate: m.route.link }, "View"),
							m("a.w3-button w3-red", { href: "/beaches/edit/" + b.doc._id, oncreate: m.route.link }, "New Debris")
							)
						])
					])
				}),
